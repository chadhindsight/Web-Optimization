...
var resizePizzas = function(size) {
  ...
  /* Replaced querySelectorAll with getElementsByClassName. Set new variable allPizzaContainers used to iterate through and set their size based on dx and newwidth. Placed variables outside of for loop. */
   ...
   function changePizzaSizes(size) {
    ...
    for (var i = 0, l= allPizzaContainers.length; i < l; i++) {
...
/* variable "pizzasDiv" is now outside the for loop & "querySelector" is replaced with "getElementById"
also added createDocumentFragment to create a imaginary node*/
...
/*I added the createDocumentFragment to create a imaginary node that will be appended. Also the user sees less than 200 pizzas at a time. Thus the user shall
only see the number of pizzas according to his browser size.*/
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < maxPizzas; i++) {
   ...
   /* elem.style.height = "100px";  moved it to style.css line: 35 */
   /* elem.style.width = "73.333px"; moved it to style.css: line: 36 */
